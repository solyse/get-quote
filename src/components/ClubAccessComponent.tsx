...
export function ClubAccessComponent({
  ...
  // Render QuickQuote mode with hero section and overlaid cards
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {shippingOptions.map((option, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-5 shadow-[0_8px_24px_rgba(0,0,0,0.15)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.2)] transition-all duration-300"
                >
                  {/* Icon and Title */}
                  <div className="flex items-center gap-2.5 mb-2.5">
                    <div className="flex items-center justify-center w-9 h-9 rounded-full bg-[#D4AF37]/10">
                      <option.icon className="w-4.5 h-4.5 text-[#D4AF37]" strokeWidth={2} />
                    </div>
                    <h3
